...
class itemunit extends CI_Controller
{
    ...
    public function update($id)
    {
        ...
        $data['title'] = 'Update';
        $data['itemunit'] = $this->itemunit_mod->get_itemunit_by_id($id);

        if (empty($data['itemunit'])) {
            show_404();
        }
        $this->load->view('templates/header');
        $this->load->view('lists/itemuniteditor', $data);
    ...
    {
        $data['itemunit'] = $this->get_postdata($id);
        ...
        if ($this->itemunit_mod->save($data['itemunit'])) {
    ...
    {
        if ($this->itemunit_mod->delete($id)) {
    ...
    public function fetch()
    {
        ...
        $response = $this->itemunit_mod->fetch_data($txttosearch);
