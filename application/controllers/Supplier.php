...
class supplier extends CI_Controller
{
    ...
    public function create()
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('supplier/editor', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function update($id)
    {
        ...
        $data['title'] = 'Update';
        $data['supplier'] = $this->supplier_mod->get_supplier_by_id($id);
    ...
    {
        $data['supplier'] = $this->get_postdata($id);
        ...
        if ($this->supplier_mod->save($data['supplier'])) {
    ...
    {
        if ($this->supplier_mod->delete($id)) {
    ...
    public function fetch()
    {
        ...
        $response = $this->supplier_mod->fetch_data($txttosearch);
