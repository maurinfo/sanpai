<?php
$editFlag = isset($disposalmethod['id']);

echo $editFlag ?
form_open('disposalmethod/save/' . $disposalmethod['id']) :
form_open('disposalmethod/save');
?>
    ...
    <div class="panel">
        ...
        <header class="panel-heading">
                <h3 class="panel-title">
                    <a style= "text-decoration:none" href="<?=base_url();?>lists/5">Lists / </a>
                    <?=$title;?>
                </h3>
        </header>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="example-wrap">
                            <input type="hidden" name="id" value="<?=($editFlag ? $disposalmethod['id'] : '')?>" />

                            <h4 class="example-title">Name</h4>
                            <span class="text-danger"><?=form_error('name');?></span>
                            <input type="text" class="form-control" name="name" placeholder="Name" value="<?=($editFlag ? $disposalmethod['name'] : '')?>" />

                            <h4 class="example-title">Furigana</h4>
                            <input type="text" class="form-control" name="yomi" placeholder="Furigana" value="<?=($editFlag ? $disposalmethod['yomi'] : '')?>" />
