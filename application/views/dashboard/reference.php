          ...
          <div class="col-xl-4 col-lg-6">
            ...
            <div class="card" id="widgetUserList">
              <div class="card-header cover overlay">
                <img class="cover-image h-200" src="<?php echo base_url();?>assets//examples/images/dashboard-header.jpg"
                  alt="..." />
                ...
                <ul class="list-group list-group-full list-group-dividered mb-0">
                    ...
                    <div class="media">
                      <div class="pr-20">
                        <a class="avatar avatar-lg" href="javascript:void(0)">
                          <img class="img-responsive" src="<?php echo base_url();?>global/portraits/1.jpg"
                            alt="...">
                        </a>
                      </div>
                  ...
                  <li class="list-group-item">
                    <div class="media">
                      <div class="pr-20">
                        <a class="avatar avatar-lg" href="javascript:void(0)">
                          <img class="img-responsive" src="<?php echo base_url();?>global/portraits/2.jpg"
                            alt="...">
                        </a>
                      </div>
                      <div class="media-body">
                  ...
                  <li class="list-group-item">
                    <div class="media">
                      <div class="pr-20">
                        <a class="avatar avatar-lg" href="javascript:void(0)">
                          <img class="img-responsive" src="<?php echo base_url();?>global/portraits/3.jpg"
                            alt="...">
                        </a>
                      </div>
                      <div class="media-body">
                  ...
                  <div class="chat chat-left">
                    <div class="chat-avatar">
                      <a class="avatar" data-toggle="tooltip" href="#" data-placement="left" title="">
                        <img src="<?php echo base_url();?>global/portraits/5.jpg" alt="Edward Fletcher">
                      </a>
                    </div>
                    <div class="chat-body">
                  ...
                  <div class="chat">
                    <div class="chat-avatar">
                      <a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="">
                        <img src="<?php echo base_url();?>global/portraits/4.jpg" alt="June Lane">
                      </a>
                    </div>
                    <div class="chat-body">
