...
<input type="hidden" id="contractorid" name="contractorid" value="<?=($editFlag ? $sale['contractorid'] : '')?>" />
<input type="hidden" id="contractorbranchid" name="contractorbranchid" value="<?=($editFlag ? $sale['contractorbranchid'] : '')?>" />
<input type="hidden" id="1forwarderid" name="1forwarderid" value="<?=($editFlag ? $sale['1forwarderid'] : '')?>" />
<input type="hidden" id="2forwarderid" name="2forwarderid" value="<?=($editFlag ? $sale['2forwarderid'] : '')?>" />
<input type="hidden" id="3forwarderid" name="3forwarderid" value="<?=($editFlag ? $sale['3forwarderid'] : '')?>" />
<input type="hidden" id="1permitid" name="1forwardpermitid" value="<?=($editFlag ? $sale['1forwardpermitid'] : '')?>" />
<input type="hidden" id="2permitid" name="2forwardpermitid" value="<?=($editFlag ? $sale['2forwardpermitid'] : '')?>" />
<input type="hidden" id="3permitid" name="3forwardpermitid" value="<?=($editFlag ? $sale['3forwardpermitid'] : '')?>" />
<input type="hidden" id="recyclefirmid" name="recyclefirmid" value="<?=($editFlag ? $sale['recyclefirmid'] : '')?>" />
<input type="hidden" id="recyclepermitid" name="recyclepermitid" value="<?=($editFlag ? $sale['recyclepermitid'] : '')?>" />
<!-- MODAL WINDOW-->
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="input-group">
                              ...
                              <input type="text" class="form-control" data-plugin="datepicker" name="datesale"
                                 value="<?=($editFlag && isset($sale['datesale']) ? date("m/d/Y", strtotime($sale['datesale'])) : '')?>" />
                           </div>
                           <br>
                        </div>
                        <div class="col-lg-6">
                           ...
                           <input type="text" class="form-control" name="referenceno" placeholder="Reference No" value="<?=($editFlag ? $sale['referenceno'] : '')?>" />
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-lg-12">
                           ...
                           <div class="input-group">
                              <input id="contractor" type="text" class="form-control" name="customer" placeholder="Contractor" value="<?=($editFlag ? $sale['contractor'] : '')?>" />
                  ...
                  <div class="panel-body">
                     <div class="row">
                        <div class="col-lg-12">
                           ...
                           <span class="text-danger"><?=form_error('referenceno');?></span>
                           <input type="text" class="form-control" name="referenceno" placeholder="Reference No" value="<?=($editFlag ? $sale['referenceno'] : '')?>" /><br>
                        </div>
                        <br>
                     </div>
                     <div class="row">
